----------------------------------------
-- File: 'ebps\environment\titan_cannon_audio_warning_01.lua'
...
GameData["entity_blueprint_ext"]["animator"] = "environment\\SP_DXP2\\ig_stronghold\\titan_cannon_audio_warning"
