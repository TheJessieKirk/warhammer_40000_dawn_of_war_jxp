----------------------------------------
-- File: 'ebps\environment\single_player_dxp\spo_02\spo_02_gate_trainer_01.lua'
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = "$695601"
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = "$695602"
GameData["ui_ext"]["ui_info"]["icon_name"] = "ork_icons\\npc_gatetrainer"
GameData["ui_ext"]["ui_info"]["screen_name_id"] = "$695600"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 695600, rangeEnd = 695649, }
