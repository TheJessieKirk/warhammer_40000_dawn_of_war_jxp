----------------------------------------
-- File: 'ebps\races\tau\structures\tau_missile_turret_sp.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[ebps\races\tau\structures\tau_turret_sp.lua]])
MetaData = InheritMeta([[ebps\races\tau\structures\tau_turret_sp.lua]])
