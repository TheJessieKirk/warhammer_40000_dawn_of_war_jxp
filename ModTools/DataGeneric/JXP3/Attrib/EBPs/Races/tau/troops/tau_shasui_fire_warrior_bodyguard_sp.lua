----------------------------------------
-- File: 'ebps\races\tau\troops\tau_shasui_fire_warrior_bodyguard_sp.lua'
...
MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 575100, rangeEnd = 575149, }
