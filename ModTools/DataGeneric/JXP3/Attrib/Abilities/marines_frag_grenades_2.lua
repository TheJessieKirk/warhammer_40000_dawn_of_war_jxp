----------------------------------------
-- File: 'abilities\marines_frag_grenades_2.lua'
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["max_lifetime"] = 2.50000
...
GameData["initial_delay_time"] = 1.33000
