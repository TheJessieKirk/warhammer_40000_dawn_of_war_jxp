----------------------------------------
-- File: 'abilities\guard_let_it_burn.lua'
...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_10"] = Reference([[type_armour\tp_commander.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = "$575051"
GameData["ui_info"]["help_text_list"]["text_02"] = "$575052"
GameData["ui_info"]["icon_name"] = "guard_icons/guard_let_it_burn_icon"
GameData["ui_info"]["screen_name_id"] = "$575050"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 575050, rangeEnd = 575099, }
