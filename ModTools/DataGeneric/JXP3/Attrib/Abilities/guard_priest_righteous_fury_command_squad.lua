----------------------------------------
-- File: 'abilities\guard_priest_righteous_fury_command_squad.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[abilities\guard_priest_righteous_fury.lua]])
MetaData = InheritMeta([[abilities\guard_priest_righteous_fury.lua]])
