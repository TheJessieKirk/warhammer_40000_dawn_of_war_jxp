----------------------------------------
-- File: 'weapon\guard_laspistol.lua'
...
GameData["ui_effective_against"]["text_01"] = "$698950"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 698950, rangeEnd = 698999, }
