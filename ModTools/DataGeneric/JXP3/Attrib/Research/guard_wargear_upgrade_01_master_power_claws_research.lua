----------------------------------------
-- File: 'research\guard_wargear_upgrade_master_power_claws_research.lua'
...
GameData["ui_info"]["screen_name_id"] = "$577700"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 577700, rangeEnd = 577749, }
