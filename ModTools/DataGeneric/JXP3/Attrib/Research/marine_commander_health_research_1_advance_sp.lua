----------------------------------------
-- File: 'research\marine_commander_health_research_1_advance_sp.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[research\marine_commander_health_research_1.lua]])
MetaData = InheritMeta([[research\marine_commander_health_research_1.lua]])
...
GameData["modifiers"]["modifier_16"]["target_type_name"] = "space_marine_chainsword_force_commander"
...
GameData["modifiers"]["modifier_17"]["target_type_name"] = "space_marine_chainsword_force_commander"
...
GameData["modifiers"]["modifier_18"]["target_type_name"] = "space_marine_power_sword_force_commander"
GameData["modifiers"]["modifier_18"]["value"] = 1.15000
GameData["modifiers"]["modifier_19"] = Reference([[modifiers\min_damage_weapon_modifier.lua]])
GameData["modifiers"]["modifier_19"]["target_type_name"] = "space_marine_power_sword_force_commander"
GameData["modifiers"]["modifier_19"]["value"] = 1.15000
