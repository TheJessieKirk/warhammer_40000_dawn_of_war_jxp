----------------------------------------
-- File: 'research\tau_wargear_upgrade_jetpack_research.lua'
...
GameData["ui_info"]["screen_name_id"] = "$579250"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 579250, rangeEnd = 579299, }
