...
MetaData["can_be_possessed_by_enemy"] = {desc = [[]], type = 3, category = [[]], dispval = [[]], }
MetaData["reanimate"] = {desc = [[]], type = 3, category = [[]], dispval = [[]], }
...
MetaData["summon_teleport_building_check_override"] = {desc = [[]], type = 3, category = [[]], dispval = [[]], }
MetaData["summon_teleport_destination"] = {desc = [[]], type = 3, category = [[]], dispval = [[]], }
