----------------------------------------
-- File: 'sbps\races\tau\tau_squad_clones\tau_builder_squad_clone.lua'
...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = "ebps\\races\\tau\\troops\\tau_troop_clones\\tau_builder_clone.lua"
