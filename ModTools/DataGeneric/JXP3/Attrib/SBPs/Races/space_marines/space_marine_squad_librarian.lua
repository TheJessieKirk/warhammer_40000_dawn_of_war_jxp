----------------------------------------
-- File: 'sbps\races\space_marines\space_marine_squad_librarian.lua'
...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = "ebps\\races\\space_marines\\troops\\librarian.lua"
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = "$672250"
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = "$672254"
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = "$672253"
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = "space_marine_icons/librarian_icon"
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = "$97070"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 672250, rangeEnd = 672299, }
