----------------------------------------
-- File: 'ebps\environment\single_player_dxp\spo_02\spo_02_headcrusher_01.lua'
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = "$695700"
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = "$695701"
GameData["ui_ext"]["ui_info"]["icon_name"] = "ork_icons\\npc_headcrusher"
GameData["ui_ext"]["ui_info"]["screen_name_id"] = "$695702"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 695700, rangeEnd = 695749, }
