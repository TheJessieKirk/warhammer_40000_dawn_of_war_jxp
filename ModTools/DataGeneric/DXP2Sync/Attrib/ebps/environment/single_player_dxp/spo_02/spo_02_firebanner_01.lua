----------------------------------------
-- File: 'ebps\environment\single_player_dxp\spo_02\spo_02_firebanner_01.lua'
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = "$695651"
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = "$695652"
GameData["ui_ext"]["ui_info"]["icon_name"] = "ork_icons\\npc_fire_banner"
GameData["ui_ext"]["ui_info"]["screen_name_id"] = "$695650"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 695650, rangeEnd = 695699, }
