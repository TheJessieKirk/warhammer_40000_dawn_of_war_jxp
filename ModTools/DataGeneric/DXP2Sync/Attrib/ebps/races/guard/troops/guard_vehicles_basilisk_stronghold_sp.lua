----------------------------------------
-- File: 'ebps\races\guard\troops\guard_vehicles_basilisk_stronghold_sp.lua'
...
GameData["ability_ext"]["abilities"]["ability_01"] = "abilities\\earthshaker_round_stronghold.lua"
