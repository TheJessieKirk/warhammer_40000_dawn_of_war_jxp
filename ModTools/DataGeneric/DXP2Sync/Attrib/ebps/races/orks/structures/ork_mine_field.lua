...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = "$697700"
GameData["ui_ext"]["ui_info"]["icon_name"] = "ork_icons/mine_field_icon"
GameData["ui_ext"]["ui_info"]["screen_name_id"] = "$94480"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 697700, rangeEnd = 697749, }
