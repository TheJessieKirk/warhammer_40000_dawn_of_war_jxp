----------------------------------------
-- File: 'ebps\races\chaos\structures\chaos_turret_missile_launcher_sp.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[ebps\races\chaos\structures\chaos_turret_bolter.lua]])
MetaData = InheritMeta([[ebps\races\chaos\structures\chaos_turret_bolter.lua]])
