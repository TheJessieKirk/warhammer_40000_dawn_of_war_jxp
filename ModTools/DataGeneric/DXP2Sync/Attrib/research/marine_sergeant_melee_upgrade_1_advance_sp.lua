----------------------------------------
-- File: 'research\marine_sergeant_melee_upgrade_1_advance_sp.lua'
...
GameData["ui_info"]["help_text_list"]["text_01"] = "$582550"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 582550, rangeEnd = 582599, }
