----------------------------------------
-- File: 'research\marine_wargear_upgrade_girdle_research.lua'
...
GameData["ui_info"]["screen_name_id"] = "$578200"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 578200, rangeEnd = 578249, }
