----------------------------------------
-- File: 'research\marine_wargear_upgrade_gauntlets_research.lua'
...
GameData["modifiers"]["modifier_14"]["value"] = 1.25000
GameData["ui_info"]["screen_name_id"] = "$578150"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 578150, rangeEnd = 578199, }
