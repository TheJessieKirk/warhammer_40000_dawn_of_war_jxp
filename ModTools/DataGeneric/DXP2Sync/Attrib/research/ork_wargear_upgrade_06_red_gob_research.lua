----------------------------------------
-- File: 'research\ork_wargear_upgrade_red_gob_research.lua'
...
GameData["ui_info"]["screen_name_id"] = "$578950"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 578950, rangeEnd = 578999, }
