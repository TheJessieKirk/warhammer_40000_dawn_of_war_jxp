----------------------------------------
-- File: 'research\necron_wargear_upgrade_death_mask_research.lua'
...
GameData["ui_info"]["screen_name_id"] = "$576100"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 576100, rangeEnd = 576149, }
