----------------------------------------
-- File: 'research\tau_requisition_research.lua'
...
GameData["ui_hotkey_name"] = "tau_requisition_research_1"
GameData["ui_index_hint"] = 5.00000
GameData["ui_info"]["help_text_list"]["text_01"] = "$707950"
GameData["ui_info"]["help_text_list"]["text_02"] = "$707951"
GameData["ui_info"]["help_text_list"]["text_03"] = "$707952"
GameData["ui_info"]["icon_name"] = "space_marine_icons/req_inc_research_1"
GameData["ui_info"]["screen_name_id"] = "$707953"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 707950, rangeEnd = 707999, }
