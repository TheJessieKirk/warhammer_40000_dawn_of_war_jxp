----------------------------------------
-- File: 'research\ork_wargear_upgrade_fasta_legz_research.lua'
...
GameData["ui_info"]["screen_name_id"] = "$578750"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 578750, rangeEnd = 578799, }
