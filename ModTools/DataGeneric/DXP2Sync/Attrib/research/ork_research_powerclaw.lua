...
GameData["requirements"]["required_1"]["population_required"] = 65.00000
...
GameData["ui_info"]["help_text_list"]["text_01"] = "$583101"
GameData["ui_info"]["help_text_list"]["text_02"] = "$95983"
GameData["ui_info"]["icon_name"] = "ork_icons/research_powerclaw_icon"
GameData["ui_info"]["screen_name_id"] = "$583100"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 583100, rangeEnd = 583149, }
