...
GameData["modifiers"]["modifier_13"]["value"] = 205.00000
...
GameData["ui_info"]["help_text_list"]["text_02"] = "$702800"
...
MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 702800, rangeEnd = 702849, }
