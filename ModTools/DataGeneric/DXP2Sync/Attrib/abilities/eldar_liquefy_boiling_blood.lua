----------------------------------------
-- File: 'abilities\eldar_liquefy_boiling_blood.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[abilities\eldar_liquefy.lua]])
MetaData = InheritMeta([[abilities\eldar_liquefy.lua]])
...
GameData["initial_delay_time"] = 2.17000
