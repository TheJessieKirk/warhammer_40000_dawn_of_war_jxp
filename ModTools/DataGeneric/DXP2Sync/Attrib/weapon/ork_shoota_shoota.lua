----------------------------------------
-- File: 'weapon\ork_shoota_shoota.lua'
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_05"]["armour_piercing_value"] = 30.45100
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 24.80000
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 20.80000
GameData["ui_effective_against"]["text_02"] = "$703750"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 703750, rangeEnd = 703799, }
