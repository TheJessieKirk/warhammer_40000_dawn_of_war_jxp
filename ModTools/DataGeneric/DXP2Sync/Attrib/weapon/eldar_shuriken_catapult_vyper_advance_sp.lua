----------------------------------------
-- File: 'weapon\eldar_shuriken_catapult_vyper_advance_sp.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[weapon\eldar_shuriken_catapult_vyper.lua]])
MetaData = InheritMeta([[weapon\eldar_shuriken_catapult_vyper.lua]])
