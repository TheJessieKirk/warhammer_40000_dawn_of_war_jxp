----------------------------------------
-- File: 'weapon\guard_autocannon_heavy_weapons_team.lua'
...
GameData["cost"]["time_seconds"] = 26.00000
...
GameData["ui_hotkey_name"] = "guard_autocannon_heavy_weapons_team"
GameData["ui_info"]["help_text_list"]["text_01"] = "$674256"
GameData["ui_info"]["help_text_list"]["text_02"] = "$674255"
GameData["ui_info"]["help_text_list"]["text_03"] = "$674254"
GameData["ui_info"]["icon_name"] = "guard_icons/heavy_weapons_autocannon"
GameData["ui_info"]["screen_name_id"] = "$674250"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 674250, rangeEnd = 674299, }
