----------------------------------------
-- File: 'weapon\guard_lasgun_guardsmen.lua'
...
GameData["ui_effective_against"]["text_01"] = "$698500"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 698500, rangeEnd = 698549, }
