----------------------------------------
-- File: 'weapon\guard_grenade_launcher_heavy_weapons_team.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[weapon\guard_grenade_launcher_guardsmen.lua]])
MetaData = InheritMeta([[weapon\guard_grenade_launcher_guardsmen.lua]])
...
GameData["ui_info"]["help_text_list"]["text_02"] = "$673650"
GameData["ui_info"]["help_text_list"]["text_03"] = "$673653"
GameData["ui_info"]["help_text_list"]["text_04"] = "$0"
GameData["ui_info"]["screen_name_id"] = "$673651"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 673650, rangeEnd = 673699, }
