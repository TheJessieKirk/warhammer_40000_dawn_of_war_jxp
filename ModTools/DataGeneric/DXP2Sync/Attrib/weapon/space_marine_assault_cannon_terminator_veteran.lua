----------------------------------------
-- File: 'weapon\space_marine_assault_cannon_terminator_veteran.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[weapon\space_marine_assault_cannon_terminator.lua]])
MetaData = InheritMeta([[weapon\space_marine_assault_cannon_terminator.lua]])
