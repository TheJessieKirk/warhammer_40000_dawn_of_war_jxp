...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = "$702350"
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = "$97803"
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = "$97804"
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = "$97805"
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = "$702351"
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = "eldar_icons/falcon_grav_tank_icon"
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = "$97800"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 702350, rangeEnd = 702399, }
