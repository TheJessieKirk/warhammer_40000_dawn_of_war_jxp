...
GameData["squad_combat_stance_ext"]["attack_priorities"]["priority_10"] = Reference([[type_armour\tp_infantry_heavy_med.lua]])
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = "$700500"
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = "$701150"
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = "$701151"
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = "$701152"
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = "$701154"
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = "ork_icons/tankbustas_icon"
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = "$97600"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 701150, rangeEnd = 701199, }
