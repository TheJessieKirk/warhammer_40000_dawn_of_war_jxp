----------------------------------------
-- File: 'ebps\environment\single_player_dxp\spd_01\spd_01_orkhole_03.lua'
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = "$695951"
GameData["ui_ext"]["ui_info"]["icon_name"] = "ork_icons\\npc_orkhole_3"
GameData["ui_ext"]["ui_info"]["screen_name_id"] = "$695950"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 695950, rangeEnd = 695999, }
