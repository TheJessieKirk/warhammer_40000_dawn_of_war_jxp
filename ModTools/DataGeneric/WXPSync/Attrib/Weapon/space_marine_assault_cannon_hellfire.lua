----------------------------------------
-- File: 'weapon\space_marine_assault_cannon_hellfire.lua'
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_05"]["armour_piercing_value"] = 12.34600
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_06"]["armour_piercing_value"] = 14.54500
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_07"]["armour_piercing_value"] = 9.94700
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_11"]["armour_piercing_value"] = 11.42100
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_12"]["armour_piercing_value"] = 17.85700
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_13"]["armour_piercing_value"] = 6.34900
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_14"]["armour_piercing_value"] = 10.58200
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 23.69200
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 19.38500
...
GameData["ui_effective_against"]["text_02"] = "$703200"
GameData["ui_info"]["icon_name"] = "space_marine_icons/upgrade_dreadnought_assault_cannon"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 703200, rangeEnd = 703249, }
