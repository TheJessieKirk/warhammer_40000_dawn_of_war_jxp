...
MetaData["go_down_time"] = {desc = [[Time it takes to go down from jump height]], type = 1, category = [[]], dispval = [[]], min = 1.000, max = 200.000, }
MetaData["go_up_time"] = {desc = [[Time it takes to go up to jump height]], type = 1, category = [[]], dispval = [[]], min = 1.000, max = 200.000, }
