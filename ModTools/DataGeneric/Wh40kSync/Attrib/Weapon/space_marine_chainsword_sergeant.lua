----------------------------------------
-- File: 'weapon\space_marine_chainsword_sergeant.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[weapon\space_marine_chainsword.lua]])
MetaData = InheritMeta([[weapon\space_marine_chainsword.lua]])
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_05"]["armour_piercing_value"] = 52.28900
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_06"]["armour_piercing_value"] = 7.61900
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 47.59600
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 38.94300
