----------------------------------------
-- File: 'ebpextensions\synckill_ext.lua'
...
MetaData["synckillinfos"] = {desc = [[]], type = 4, category = [[]], dispval = [[]], }
