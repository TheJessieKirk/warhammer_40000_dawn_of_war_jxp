----------------------------------------
-- File: 'abilities\eldar_leadership_howling_banshee_leader.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[abilities\eldar_leadership.lua]])
MetaData = InheritMeta([[abilities\eldar_leadership.lua]])
