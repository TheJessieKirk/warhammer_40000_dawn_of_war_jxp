----------------------------------------
-- File: 'abilities\ork_warboss_throw_sp.lua'
...
GameData["ui_info"]["screen_name_id"] = "$694700"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 694700, rangeEnd = 694749, }
