----------------------------------------
-- File: 'weapon\ork_slugga_armored_nob.lua'
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage_value"] = 20.50000
GameData["area_effect"]["weapon_damage"]["armour_damage"]["morale_damage"] = 10.00000
GameData["reload_time"] = 1.00000
GameData["ui_effective_against"]["text_02"] = "$703600"
GameData["ui_effective_against"]["text_03"] = "$703601"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 703600, rangeEnd = 703649, }
