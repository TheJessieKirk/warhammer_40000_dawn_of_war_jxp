----------------------------------------
-- File: 'weapon\ork_slugga_nob.lua'
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 14.80000
...
GameData["ui_effective_against"]["text_02"] = "$703550"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 703550, rangeEnd = 703599, }
