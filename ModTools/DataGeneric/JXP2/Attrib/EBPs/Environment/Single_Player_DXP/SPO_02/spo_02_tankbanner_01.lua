----------------------------------------
-- File: 'ebps\environment\single_player_dxp\spo_02\spo_02_tankbanner_01.lua'
...
GameData["entity_blueprint_ext"]["scale_y"] = 6.00000
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = "$695800"
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = "$695802"
GameData["ui_ext"]["ui_info"]["icon_name"] = "ork_icons\\npc_tank_banner"
GameData["ui_ext"]["ui_info"]["screen_name_id"] = "$695801"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 695800, rangeEnd = 695849, }
