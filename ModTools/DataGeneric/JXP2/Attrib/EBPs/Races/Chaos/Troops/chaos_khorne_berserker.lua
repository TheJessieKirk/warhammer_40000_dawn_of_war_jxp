...
GameData["health_ext"]["hitpoints"] = 610.00000
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = "$693903"
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = "$693901"
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = "$693902"
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = "$693904"
GameData["ui_ext"]["ui_info"]["icon_name"] = "chaos_icons/chaos_marine_icon_khorne_berzerker"
GameData["ui_ext"]["ui_info"]["screen_name_id"] = "$693900"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 693900, rangeEnd = 693949, }
