----------------------------------------
-- File: 'sbps\races\eldar\eldar_squad_fire_dragon.lua'
...
GameData["squad_combat_stance_ext"]["ranged_attackrange"] = 10.00000
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = "$694302"
